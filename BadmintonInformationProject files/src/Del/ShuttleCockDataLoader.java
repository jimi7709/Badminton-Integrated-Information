...
public class ShuttleCockDataLoader {
    private static final String filePath = "./src";
    private static final String fileNm = "ShuttleCock.xlsx";

    private JTextArea textArea;
    private ImagePanel imagePanel;

    public ShuttleCockDataLoader(JTextArea textArea, ImagePanel imagePanel) {
